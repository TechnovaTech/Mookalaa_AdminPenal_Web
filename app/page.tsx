      ...
      <div className="flex-1 ml-64 transition-all duration-300 min-h-screen">
        ...
        <main className="p-10 mt-24">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-r from-emerald to-teal rounded-xl p-6 text-white">
              <h3 className="text-lg font-bold mb-2">Pending KYC</h3>
              <p className="text-emerald-100 mb-4">23 applications waiting for review</p>
              <button className="bg-white text-emerald px-4 py-2 rounded-lg font-medium hover:bg-gray-100 transition-colors">
                Review Now
              </button>
            </div>
            
            <div className="bg-gradient-to-r from-indigo to-deep-blue rounded-xl p-6 text-white">
              <h3 className="text-lg font-bold mb-2">Event Approvals</h3>
              <p className="text-blue-100 mb-4">12 events pending approval</p>
              <button className="bg-white text-indigo px-4 py-2 rounded-lg font-medium hover:bg-gray-100 transition-colors">
                Approve Events
              </button>
            </div>
            
            <div className="bg-gradient-to-r from-slate-gray to-gray-600 rounded-xl p-6 text-white">
              <h3 className="text-lg font-bold mb-2">Payouts</h3>
              <p className="text-gray-100 mb-4">₹2,45,000 ready for payout</p>
              <button className="bg-white text-gray-700 px-4 py-2 rounded-lg font-medium hover:bg-gray-100 transition-colors">
                Process Payouts
              </button>
            </div>
          </div>
